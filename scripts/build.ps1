...
Invoke-Checked { & $ProjectPython -m openpptbench.cli build-site public/rankings.json --products data/products --workflows data/workflows --sources data/sources/catalog-v0.1.json --research data/research/landscape-v0.1.json --benchmarks benchmark/sources/registry-v0.2.yaml --output-dir public/site }
